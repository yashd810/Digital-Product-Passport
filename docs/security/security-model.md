...
| API key scope checks | what machine clients can read or write |
...
- [apps/backend-api/src/services/access-rights-service.js](/Users/yashdesai/Desktop/Digital Product Passport/Project Files/APP/files/apps/backend-api/src/services/access-rights-service.js:1)
...
3. check public filtering or access-rights service behavior
