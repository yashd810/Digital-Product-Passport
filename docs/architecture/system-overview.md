...
Current product module files live in:
...
| Add a product passport module | `apps/backend-api/src/passport-modules/...` |
| Add semantic model resources | `apps/backend-api/resources/semantics/...` |
