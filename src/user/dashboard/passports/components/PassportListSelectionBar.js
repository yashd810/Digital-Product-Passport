  ...
  return (
    <div className="bulk-actions-bar">
      ...
      <div className="bulk-actions-buttons">
        <button className="bulk-action-btn bulk-action-release" onClick={bulkRelease} disabled={bulkActionLoading} title="Release selected draft/in-revision passports">
          🎯 Release
        </button>
        ...
        <button className="bulk-action-btn bulk-action-export" onClick={bulkExportJson} disabled={bulkActionLoading} title="Download selected passports as JSON">
          📦 Export JSON
        </button>
