        ...
        <div className="table-container">
          ...
          <div className="table-scroll-wrapper">
            <table className="passports-table">
              <thead>
                <tr>
                  <th><button type="button" className="table-sort-btn" onClick={() => toggleSort("model_name")}>Passport{sortIndicator(sortConfig, "model_name") && ` ${sortIndicator(sortConfig, "model_name")}`}</button></th>
