...
async function run() {
      ...
      fields: [
        {
          ...
          semanticId: "https://example.test/terms/publicField",
        },
        {
          key: "secretAlpha",
          label: "Secret alpha",
          ...
          semanticId: "https://example.test/terms/secretAlpha",
        },
        {
          key: "secretBeta",
          label: "Secret beta",
          type: "text",
          confidentiality: "restricted",
          semanticId: "https://example.test/terms/secretBeta",
        },
        {
          key: "publicDynamic",
          label: "Public dynamic",
          type: "text",
          dynamic: true,
          confidentiality: "public",
          semanticId: "https://example.test/terms/publicDynamic",
        },
        {
          key: "restrictedDynamicAlpha",
          label: "Restricted dynamic alpha",
          type: "text",
          dynamic: true,
          confidentiality: "restricted",
          semanticId: "https://example.test/terms/restrictedDynamicAlpha",
        },
        {
          key: "restrictedDynamicBeta",
          label: "Restricted dynamic beta",
          type: "text",
          dynamic: true,
          confidentiality: "restricted",
          semanticId: "https://example.test/terms/restrictedDynamicBeta",
        },
        {
          key: "unclassifiedField",
          label: "Unclassified field",
          type: "text",
          semanticId: "https://example.test/terms/unclassifiedField",
        },
        {
          key: "unclassifiedDynamic",
          label: "Unclassified dynamic",
          type: "text",
          dynamic: true,
          semanticId: "https://example.test/terms/unclassifiedDynamic",
        },
        {
          key: "publicDocument",
          ...
          type: "file",
          confidentiality: "public",
          semanticId: "https://example.test/terms/publicDocument",
        },
        {
          key: "restrictedDocument",
          label: "Restricted document",
          type: "file",
          confidentiality: "restricted",
          semanticId: "https://example.test/terms/restrictedDocument",
        },
      ],
    }],
  };
  ...
  try {
    ...
    const unclassifiedSchemaField = publicRead.payload.viewerSchema.fieldsJson.sections[0].fields
