...
/**
 * Deterministic JSON serialization for hashes, signatures, and audit records.
 *
 * Object keys are recursively sorted and unsupported values fail explicitly so
 * two equivalent payloads always yield the same serialized representation.
 */
