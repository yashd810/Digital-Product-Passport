...
/**
 * External backup-provider adapter.
 *
 * It manages provider-scoped object storage and replication mechanics without
 * owning Passport workflow decisions or HTTP request handling.
 */
