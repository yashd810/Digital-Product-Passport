...
/**
 * Shared structured logger with centralized secret redaction.
 *
 * Platform code owns output format and sensitive-field handling so API routes,
 * modules, scripts, and database setup never duplicate logging safeguards.
 */
