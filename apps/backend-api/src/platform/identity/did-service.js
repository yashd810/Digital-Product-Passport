...
/**
 * Platform DID construction and safe identifier normalization.
 *
 * Product modules use this adapter to derive stable, origin-aware identities
 * without embedding URL, hostname, or path-safety rules in route handlers.
 */
