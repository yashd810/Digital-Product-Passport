...
/**
 * OAuth/OIDC provider adapter.
 *
 * This platform boundary validates remote provider metadata and identity tokens
 * while authentication routes retain control of the product login workflow.
 */
