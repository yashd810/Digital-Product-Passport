...
/**
 * Shared password-policy, OTP, and device-secret primitives.
 *
 * Centralizing these rules keeps all authentication entrypoints aligned on the
 * same validation and secret-derivation behavior.
 */
