 ...
 *
 * This module creates the Express application, connects its cross-feature
 * services, registers route families, and owns process lifecycle. Keep product
 * rules in feature-owned `modules/` services or cross-cutting `platform/`
 * adapters; this file should only wire collaborators.
 */
...
const createSigningService     = require("../platform/security/signing-service");
const createDidService         = require("../platform/identity/did-service");
const createCanonicalPassportSerializer = require("../modules/passports/services/canonical-passport-serializer");
const createCacheService       = require("../platform/cache/create-cache-service");
const createStorageService     = require("../platform/storage/storage-service");
const createOauthService       = require("../platform/identity/oauth-service");
const createPasswordService    = require("../platform/security/password-service");
const logger                   = require("../platform/observability/logger");
const { createTransporter, brandedEmail, sendOtpEmail, renderInfoTable } = require("../platform/communications/email-service");
const { validatePasswordPolicy, hashSecret, hashOtpCode, generateOtpCode, passwordMinLength, createDeviceKeyMaterial } = require("../platform/security/security-service");
...
const createAssetService       = require("../modules/assets/asset-management-service");
const { assertAssetManagementEntitlement } = require("../shared/assets/asset-management-entitlement");
const createPassportService    = require("../modules/passports/services/passport-service");
const createSemanticPassportExportService = require("../modules/passports/services/semantic-passport-export");
const createSemanticModelRegistry         = require("../modules/passports/services/semantic-model-registry");
const createComplianceService             = require("../modules/passports/services/required-fields-service");
const createProductIdentifierService      = require("../modules/passports/services/product-identifier-service");
const createBackupProviderService         = require("../platform/backups/backup-provider-service");
...
// ─── DIRECTORIES ─────────────────────────────────────────────────────────────
const runtimePaths = deriveRuntimePaths(sourceRoot);
const {
...
const {
  ...
  listAuditLogAnchors,
  anchorAuditLogRoot,
  getPassportTypeSchema, hasCompanyPassportTypeAccess, findExistingPassportByInternalAliasId, findExistingPassportByBusinessIdentifier,
...
configureHttpErrorHandling(app, { logger });
...
configureServerLifecycle({
  ...
  stopAssetManagementScheduler: assetService.stopAssetManagementScheduler,
  shutdownTimeoutMs,
});
