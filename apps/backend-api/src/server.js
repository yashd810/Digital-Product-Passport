...
const createSigningService     = require("./infrastructure/signing/create-signing-service");
const createDidService         = require("./infrastructure/identity/create-did-service");
const createCanonicalPassportSerializer = require("./shared/passports/canonical-passport-serializer");
const createCacheService       = require("./infrastructure/cache/create-cache-service");
const createStorageService     = require("./infrastructure/storage/create-storage-service");
const createOauthService       = require("./infrastructure/oauth/create-oauth-service");
const createPasswordService    = require("./infrastructure/security/create-password-service");
const logger                   = require("./infrastructure/logging/logger");
const { createTransporter, brandedEmail, sendOtpEmail, renderInfoTable } = require("./infrastructure/email/email-service");
const { validatePasswordPolicy, hashSecret, hashOtpCode, generateOtpCode, PASSWORD_MIN_LENGTH, createAccessKeyMaterial, createDeviceKeyMaterial } = require("./infrastructure/security/security-service");
...
const createAssetService       = require("./infrastructure/assets/create-asset-service");
const createPassportService    = require("./infrastructure/passports/create-passport-service");
const createSemanticPassportExportService = require("./services/semantic-passport-export");
const createPassportRepresentationService = require("./infrastructure/passports/create-passport-representation-service");
const dppIdentity                         = require("./shared/identifiers/dpp-identity-service");
const createSemanticModelRegistry         = require("./infrastructure/semantics/create-semantic-model-registry");
const createComplianceService             = require("./infrastructure/compliance/create-compliance-service");
const createAccessRightsService           = require("./infrastructure/security/create-access-rights-service");
const createProductIdentifierService      = require("./infrastructure/identifiers/create-product-identifier-service");
const createBackupProviderService         = require("./infrastructure/backup/create-backup-provider-service");
