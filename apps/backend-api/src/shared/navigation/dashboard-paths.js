...
function slugifyDashboardCompany(value, fallback = "company") {
...
function resolveDashboardCompanySlug({ companySlug = "", companyName = "", companyId = "" } = {}) {
  return slugifyDashboardCompany(companySlug || companyName || (companyId ? `company-${companyId}` : ""), "company");
}

function buildDashboardPath({ companySlug = "", companyName = "", companyId = "", subpath = "" } = {}) {
...
module.exports = {
  buildDashboardPath,
  resolveDashboardCompanySlug,
  slugifyDashboardCompany,
};
