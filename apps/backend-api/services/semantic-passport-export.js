...
function createSemanticPassportExportService({
  ...
  function isBatteryPassExportType(passportType, options = {}, typeDef = null) {
    const model = resolveSemanticModel({ passportType, typeDef, options });
    return model?.semanticModelKey === BATTERY_DICTIONARY_MODEL_KEY;
  }
