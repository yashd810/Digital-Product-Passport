// Dictionary feature: shared data loading and presentation across public, company, and admin routes.
...
/**
 * Dictionary browsing feature shared by public, company, and admin routes.
 *
 * Route context determines the surrounding navigation path; dictionary data is
 * always fetched from the API and rendered through one consistent interface.
 */
