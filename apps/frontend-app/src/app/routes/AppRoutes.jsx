 ...
 *
 * This module owns route paths, guards, lazy boundaries, and route-to-feature
 * wiring. Session state is created by the app shell and passed in explicitly.
 */
...
const DictionaryBrowserPage = lazy(() => import("../../dictionary/DictionaryBrowserPage"));
