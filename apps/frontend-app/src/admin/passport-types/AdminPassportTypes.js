              ...
              <div className="apt-cards">
                  ...
                  <div className="apt-card apt-draft-card-inline">
                    ...
                    <div className="apt-card-meta">
                      <span className="apt-card-meta-primary">
                        {countSchemaFields(draftType.sections || [])} fields
                        {" "}across {countSchemaSections(draftType.sections || [])} sections
                      </span>
                ...
                {umbTypes.map(t => (
                  <div key={t.id} className={`apt-card ${t.isActive ? "" : "apt-card-inactive"}`}>
                    ...
                    <div className="apt-card-meta">
                      <span className="apt-card-meta-primary">
                        {countSchemaFields(t.fieldsJson?.sections || [])} fields
                        across {countSchemaSections(t.fieldsJson?.sections || [])} sections
                      </span>
